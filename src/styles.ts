...
export function getStyles() {
  return {
    ...
    "editor.foreground": VitesseThemes.foreground[0],
    "editor.background": VitesseThemes.background[0],
    "editor.gutter.background": VitesseThemes.background[0],
    "editor.subheader.background": VitesseThemes.background[0],
    "editor.active_line.background": VitesseThemes.background[0],
    "editor.highlighted_line.background": VitesseThemes.background[0],
    "editor.line_number": VitesseThemes.foreground[0],
    "editor.active_line_number": VitesseThemes.activeForeground[0],
    "editor.invisible": "red",
    "editor.wrap_guide": "blue",
    "editor.active_wrap_guide": "green",
    "editor.document_highlight.read_background": "purple",
    "editor.document_highlight.write_background": "orange",
