...
export function getStyle(...args: StyleArgs) {
	...
	return {
		...
		'version_control.word_added': color('green', 'semi-transparent'),
		'version_control.word_deleted': color('red', 'semi-transparent'),
		...
		syntax: {
			...
			'function.special.definition': syntax('foreground'),
			...
			module: syntax(color('variable')),
			namespace: syntax(color('interface')),
			number: syntax(color('number')),
			'number.float': syntax(color('number')),
			...
			preproc: syntax(color('namespace')),
